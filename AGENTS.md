...
- `main`は`Protect main` Rulesetで保護し、Pull Requestとfrontend、backend、Browser Smokeのrequired checksをGitHub側でも強制する。Rulesetは`infrastructure/github/`のTerraformを正本とし、Web UIで直接変更しない
